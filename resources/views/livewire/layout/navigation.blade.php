        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div class="flex flex-row items-center gap-4">
                    <img class="moon cursor-pointer w-6"
                        src="https://img.icons8.com/?size=100&id=648&format=png&color=000000" alt="Moon Icon" />
                    <img class="sun cursor-pointer w-6 hidden"
                        src="https://img.icons8.com/?size=100&id=88SZJSqr139N&format=png&color=FFFFFF" alt="Sun Icon" />
                </div>
